  ...
  return (
    <footer className="bg-green-700 rounded-3xl shadow-md py-10 px-6 mx-6 mt-16 mb-0">
      <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-3 gap-12 items-start">
        ...
        <div>
          ...
          <div className="flex items-center space-x-2 mb-4">
            ...
            <span className="text-white text-xl font-semibold tracking-wider">RiceVision</span>
          </div>
          ...
          <div className="flex space-x-4 mb-8">
            {socialIcons.map((icon, idx) => (
              <a
                key={idx}
                href={icon.href}
                className="text-green hover:text-yellow-700 transition"
          ...
          <button
            className="border border-gray-400 text-gray-100 px-6 py-2 rounded-lg mt-1 flex space-x-2 items-center hover:bg-teal-800 transition"
        ...
        <div>
          ...
          <ul className="space-y-2 text-gray-100">
            <li><a href="homepage" className="underline">Homepage</a></li>
            <li><a href="#mission" className="underline">Mission</a></li>
            <li><a href="#goal" className="underline">Goal</a></li>
            <li><a href="#features" className="underline">Features</a></li>
      ...
      <div className="bg-green-700 mt-10 rounded-b-3xl text-center py-2 text-gray-800 text-sm">
        Copyright © {new Date().getFullYear()}, ricevisionlanka, All Rights Reserved.
      </div>
    </footer>
  );
}

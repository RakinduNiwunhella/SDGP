...
export default function ComplaintDetailsModal({ onClose }) {
  const { id } = useParams();
  ...
  return (
    <div
      className="fixed inset-0 z-50 flex items-center justify-center bg-black/50 p-4 overflow-y-auto animate-fadeIn"
